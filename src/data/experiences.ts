...
export const experiences: Experience[] = [
  {
    ...
    description:
      "TNK, Tapjoy 등 다양한 광고사의 오퍼월 SDK를 연동하여 추가 수익 구조를 구축. Native Module 개발로 JavaScript와 네이티브 코드 연결.",
    details: [
    ...
    tags: ["React Native", "Native Module", "SDK Integration", "Java/Kotlin", "Swift"],
    videoUrl: "https://prod-files-secure.s3.us-west-2.amazonaws.com/ac994adc-23ab-495b-9ad1-c7168d2840bc/863b6301-d7ba-428b-9cb1-5910d6b4d77c/캐시버튼.mp4",
  },
  {
    id: "admob-bidding",
    ...
    title: "애드몹 입찰 광고 도입",
    description:
      "광고 소스 부족 문제 해결을 위해 여러 광고 업체의 소스를 통합하는 입찰 광고 도입. 공식 문서와 구글 담당자 피드백으로 문제 해결.",
    details: [
    ...
    videoUrl: "https://prod-files-secure.s3.us-west-2.amazonaws.com/ac994adc-23ab-495b-9ad1-c7168d2840bc/3a968997-4019-49f3-9f36-807f43bad8b1/애드몹.mp4",
  },
  {
    id: "app-rebuild",
    ...
    title: "마일벌스 앱 전면 재개발",
    description:
      "React Native 라이브러리 버전 업그레이드를 위한 새 프로젝트 설정. 3개월간 60여 개 페이지 프론트엔드 개발 주도.",
    details: [
  ...
  },
  {
    ...
    title: "마일벌스 어드민 리뉴얼",
    description:
      "React Query를 사용한 서버 데이터 캐싱 처리로 응답 속도 향상. Ag-Grid로 수만 건의 데이터 필터링, 페이징, 정렬 기능 구현.",
    details: [
  ...
  },
  {
    ...
    description:
      "HTML, CSS, jQuery로 작성된 기존 홈페이지를 리팩토링. 컴포넌트 기반 아키텍처 도입과 반응형 레이아웃 적용.",
    details: [
