  ...
  return (
    <section id="experience" className="py-24 px-6" ref={ref}>
      <div className="max-w-4xl mx-auto">
        ...
        >
          <span className="text-sm text-primary uppercase tracking-wider">Experience</span>
          <h2 className="text-3xl md:text-4xl font-bold mt-2 mb-4">Work Experience</h2>
          <p className="text-neutral-400 mb-12">
            ㈜트러스트체인에서 마일벌스 서비스 관련 홈페이지, 앱, 어드민 개발을 담당했습니다.
          </p>
        </motion.div>
          ...
          {experiences.map((exp, index) => (
            ...
            >
              ...
              <div
                ...
                className="bg-neutral-900 p-6 rounded-xl border border-neutral-800 hover:border-primary transition-all cursor-pointer group hover:translate-x-2"
              >
